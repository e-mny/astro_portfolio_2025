...
export default function netlifyIntegration(integrationConfig) {
    ...
    async function writeRedirects(routes, dir, buildOutput, assets) {
        // all other routes are handled by SSR
        const staticRedirects = routes.filter((route) => route.type === 'redirect' && (route.redirect || route.redirectRoute));
    ...
    async function writeSSRFunction({ notFoundContent, logger, root, }) {
